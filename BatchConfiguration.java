...
public class BatchConfiguration {
	...
	@Autowired
	ZipGenerationTasklet taskletStep;
	...
	public FlatFileItemWriter<MongoDBEntity> writer() {
		...
		writer.setHeaderCallback(fileHeader);
	...
	public Job exportUserJob() throws ParseException {
		return jobBuilderFactory.get("exportUserJob").flow(step1()).next(step2()).end().build();
	}
	...
	public Step step1() throws ParseException {
		return stepBuilderFactory.get("step1").<MongoDBEntity, MongoDBEntity>chunk(10).reader(reader())
